...
link:https://github.com/markllama/dhcpd-container/FEDORA_BASE.adoc[ISC DHCP - Fedora Base] the base image is ~
...
link:https://github.com/markllama/dhcpd-container/FEDORA_BASE.adoc[Fedora based] image. The real payoff is in the
the size savings.
